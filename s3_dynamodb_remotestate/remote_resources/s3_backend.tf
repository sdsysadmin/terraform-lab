...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "tflab-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "tflab-tfremotestate" {
  bucket = aws_s3_bucket.tflab-tfremotestate.id
